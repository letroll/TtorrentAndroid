...
import fr.letroll.ttorrentandroid.client.storage.TorrentByteStorage;
import fr.letroll.ttorrentandroid.client.storage.FileStorage;
import fr.letroll.ttorrentandroid.client.storage.FileCollectionStorage;
...
public class TorrentHandler implements TorrentMetadataProvider {
     ...
     * files.
     * @throws java.io.FileNotFoundException If the torrent file location or
     * destination directory does not exist and can't be created.
     * @throws java.io.IOException If the torrent file cannot be read or decoded.
     */
