 ...
 */
package fr.letroll.ttorrentandroid.client.storage;
...
public interface TorrentByteStorage extends Closeable {
     ...
     * byte storage and return them in a {@link java.nio.ByteBuffer}.
     * This method does NOT call {@link java.nio.ByteBuffer#flip()}.
     * </p>
     *
     ...
     * </p>
     *
     * @param block A {@link java.nio.ByteBuffer} containing the bytes to write to the
     ...
     * @throws java.io.IOException If an I/O error occurs while writing to the byte
     * storage.
     */
     ...
     *
     * @throws java.io.IOException If closing the underlying storage (file(s) ?)
     * failed.
     */
    @Override
     ...
     * </p>
     *
     * @throws java.io.IOException If the finalization failed.
     */
