...
import fr.letroll.ttorrentandroid.client.peer.PieceHandler.AnswerableRequestMessage;
 ...
 * @author shevek
 */
public class PieceHandler implements Iterable<PieceHandler.AnswerableRequestMessage> {
